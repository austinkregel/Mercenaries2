...
dump_consts("Pda.Database.AddHelpEntry", Pda.Database.AddHelpEntry)
dump_consts("Pda.Database.AddLogEntry", Pda.Database.AddLogEntry)
dump_consts("Pda.Database.AddDossierEntry", Pda.Database.AddDossierEntry)
